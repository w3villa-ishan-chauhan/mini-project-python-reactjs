...
function App() {
    ...
    const { login , setUserRole} = useAuth(); // Access the auth context
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.access_token && result.role==="user" ||  result.role==="") {
                login(result.access_token);
                setUserRole(setUserRole(result.role))
                toast.success("Login Successful")
                navigate('/home');
            }
            else if(result.access_token && result.role==="admin"){
                login(result.access_token);
                toast.success("Login Successful")
                navigate('/admin');
            }
